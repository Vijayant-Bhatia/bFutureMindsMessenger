...
package com.barclaycard.hackathon.befuturemind.api.util;
...
public class IOUtils {
   ...
   * @param charset Convert string to bytes according to given {@link java.nio.charset.Charset}
   ...
   * @param charset Convert bytes to chars according to given {@link java.nio.charset.Charset}
